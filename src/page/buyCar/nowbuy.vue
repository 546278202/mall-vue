...
<script>
    ...
    export default {
        ...
        mounted() {
            this.goodsObj=JSON.parse(sessionStorage.getItem("nowbuylist"))
        ...
        methods: {
            ...
            calTotalMoney: function () {
                ...
                for (var i = 0, len = this.goodsObj.length; i < len; i++) {
                    var list = this.goodsObj[i];
                        oThis.totalMoney +=
                        parseFloat(list.wareprice) * parseFloat(list.quantity);
            ...
            addUp(index1, index) {
                var list = this.goodsObj[index1];
                ++this.goodsObj[index1][index].quantity;
            },
            addDown() {
                if (this.buyNum > 1) {
                    this.buyNum--;
